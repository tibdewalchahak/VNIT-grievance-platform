      ...
      <div className="w-full max-w-md">
        <div className="bg-white/80 backdrop-blur-xl shadow-2xl rounded-3xl p-8 border border-gray-100">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm">Join the hostel grievance management system</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5" data-testid="register-form">
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={(value) => updateFormData('role', value)} required>
                <SelectTrigger className="h-11 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-xl" data-testid="role-select">
            ...
            {formData.role === 'resident' && (
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-2">
                  <Label htmlFor="floor" className="text-gray-700 font-medium">Floor</Label>
                  <Input
                    id="floor"
                    placeholder="1"
                ...
                <div className="space-y-2">
                  <Label htmlFor="room" className="text-gray-700 font-medium">Room</Label>
                  <Input
                    id="room"
                    placeholder="101"
                    value={formData.room}
            ...
            {formData.role === 'worker' && (
              <div className="space-y-2">
                ...
                <Select onValueChange={(value) => updateFormData('specialization', value)} required>
                  <SelectTrigger className="h-11 border-gray-200 focus:border-blue-500 focus:ring-2 focus:ring-blue-200 rounded-xl" data-testid="specialization-select">
